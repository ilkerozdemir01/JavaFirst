...
public class NestedTernary01 {
    public static void main(String[] args) {
        ...
        /*
             Asagidaki kurallara göre password'un gecerli olup olmadigini kontrol eden kodu yaziniz
             1_Sekiz karakterden fazla veya sekiz karakter varsa ilk harfi 'i' olmalidir
             2_Sekiz karakterden az karakter varsa ilk harfi 'K' olmalidir
         */
