...
public class StringManipulations01 {
    ...
    public static void main(String[] args) {
        ...
        int idxIss2 = s.lastIndexOf("iss");//Son gorunumun "ilk" character'inin indexini verir
        System.out.println("Baba" +idxIss2);

        //Example1: Bir String'deki bir character'in tekrarli veya tekrarsiz olup olmadigini gosteren kodu yaziniz
        ...
        // en bastan bu indexe kadar olan karakterleri bir kutu icine aliniz ve lastIndexOf() method'unu sadece bu kutu icindeki String icin kullaniriz
